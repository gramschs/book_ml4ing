...
**künstliche Neuron** zu verallgemeinern. Später werden wir die künstliche
...
Bei diesen sogenannten neuronalen Netzen
...
als Aktivierungsfunktion verwendet. Weil beide Funktionen einen glatten Verlauf
haben (keine Knicke wie die Heaviside-Funktion), können die Gewichte $w_0, w_1,
\ldots, w_n$ mit mathematischen Optimierungsverfahren besser bestimmt werden. Im
nächsten Kapitel werden wir sehen, wie das in der Praxis mit Scikit-Learn
funktioniert.
...
## Viele Perzeptrons = neuronales Netz

Neuronale Netze sind Netze aus einzelnen künstlichen Neuronen. Im Folgenden
werden wir auf eine mathematisch präzise Beschreibung von neuronalen verzichten
und stattdessen das Konzept eines neuronalen Netzes anhand von Schemazeichnungen
erläutern. Dazu vereinfachen wir zunächst die schematische Darstellung des
künstlichen Neurons. Zunächst Wir stellen die beiden Funktionen Übertragungsfunktion
(Bilden der gewichteten Summe) und Aktivierungsfunktion in einem Kreis in der
Mitte gemeinsam dar. Die Bias-Einheit lassen wir in der Darstellung ebenfalls weg
...
Bei neuronalen Netzen werden mehrere Schichten mit vielen Neuronen kombiniert.
Wenn ein Netz zwei oder mehr versteckte Schichten hat, sprechen wir von **Deep
Learning** oder **tiefen neuronalen Netzen**. Das "Deep" (tief) bezieht sich auf
die vielen Schichten, die das Netz "tief" machen, ähnlich wie ein tiefer Keller
mehrere Stockwerke hat.

Diese tiefen Netze sind extrem leistungsfähig und können komplexe Muster
erkennen. Sie benötigen aber auch viele Trainingsdaten mit guter Qualität.
