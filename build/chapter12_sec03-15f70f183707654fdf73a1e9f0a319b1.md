...
vor, so erschwert wird das Training erschwert. Daher ist es sinnvoll, die Daten
auf ähnliche Bereich zu skalieren. In dem obigen Beispiel sind die künstlichen
Daten jedoch bereits in einem ähnlichen Größenbreich.
