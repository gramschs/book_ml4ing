...
:class: hint
```
Oft ist das Skalieren der Daten besser als das Erhöhen der
maximalen Anzahl an Iterationen. Im Maschinenbau messen wir oft Größen mit sehr
...
ähnliche Bereich zu skalieren. In dem obigen Beispiel sind die künstlichen Daten
