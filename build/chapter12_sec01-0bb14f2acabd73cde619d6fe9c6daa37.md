...
mathematische Operationen durchgeführt werden, sind die beiden Kreise hellgrau
eingefärbt. Das Ergebnis, der Output $\hat{y}$ wird dann berechnet und wiederum
als (dunkelblauer) Kreis gezeichnet.

Selbstverständlich können die Farben in anderen Abbildungen andersgewählt sein.
