...
als Aktivierungsfunktion verwendet.
...
Beide Funktionen haben einen glatten Verlauf (keine Knicke wie die
Heaviside-Funktion). Daher können die Gewichte $w_0, w_1, \ldots, w_n$ mit
mathematischen Optimierungsverfahren besser bestimmt werden. Im nächsten Kapitel
werden wir sehen, wie das in der Praxis mit Scikit-Learn funktioniert. Vorher
beschäftigen wir uns mit dem Zusammensetzen von vielen Perzeptronen zu einem
neuronalen Netz.
