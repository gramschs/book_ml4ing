...
davon aus, dass die mit dem negativen Schwellenwert $-\theta$ und $1$
...
Inputs $x_i$ mit den Gewichten $\omega_i$ wird durch Kanten dargestellt. Die
einzelnen Summanden $x_i \omega_i$ treffen sich sozusagen im mittleren Kreis, wo
auf die gewichtete Summe dann eine Aktivierungsfunktion angewendet wird. Das
Ergebnis, der Output $\wedge{y}$ wird dann berechnet und wiederum als Kreis
gezeichnet.
