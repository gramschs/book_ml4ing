...
zu prognostizieren (dunkelblauer Kreis). Die folgende Schmezeichnung
verdeutlicht diese Vorgehensweise für vier Merkmale (die Bias-Einheit wurde
wieder weggelassen).

```{figure} pics/fig_12_02_MLP_1layer_2neurons.svg
---
width: 100%
...
2. Jedes der 2 Neuronen der versteckten Schicht ist mit 1 Ausgabeneuron
