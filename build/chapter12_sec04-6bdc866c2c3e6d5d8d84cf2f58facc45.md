...
:class: tip
1. Trainieren Sie ein `MLPRegressor` mit den numerischen Eigenschaften (Karat,
   Tiefe, Tafel, x, y, z).
2. Skalieren Sie die Daten mit `StandardScaler`.
3. Experimentieren Sie mit verschiedenen Architekturen:
   * `hidden_layer_sizes=(10,)`
   * `hidden_layer_sizes=(20, 10)`
   * `hidden_layer_sizes=(50, 25, 10)`
4. Verwenden Sie Gittersuche, um die beste Architektur zu finden.
5. Vergleichen Sie das beste neuronale Netz mit linearer Regression.
6. Bewerten Sie: Wann lohnt sich der Einsatz eines neuronalen Netzes?
```
