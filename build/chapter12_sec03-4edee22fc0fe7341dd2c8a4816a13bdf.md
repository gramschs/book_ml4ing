...
erhalten auch eine Warnung `Stochastic Optimizer: Maximum iterations (200)
reached and the optimization hasn't converged yet.`. Neuronale Netze können zwar
...
```{code-cell} ipython3
# Auswahl des Modells
neuronales_netz = MLPClassifier(hidden_layer_sizes=(10,10))
