...
# Hinweis: Die Gittersuche kann je nach Computer 5-15 Minuten dauern,
# da 15 Konfigurationen mit jeweils 5-facher Kreuzvalidierung getestet werden.
...
da wir viele Daten haben und die Genauigkeit besser ist als bei den 
anderen Modellen.
````
