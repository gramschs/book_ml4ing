...
x_j w_j$ gebildet wird. Auf die gewichtete Summe wird dann eine
Aktivierungsfunktion angewendet, was durch einen weiteren Kreis dargestellt
wird. Um zu verdeutlichen, dass hier zwei mathematische Operationen durchgeführt
werden, sind die Kreise hellgrau eingefärbt. Das Ergebnis, der Output $\hat{y}$
wird dann berechnet und wiederum als (dunkelblauer) Kreis gezeichnet.
