...
gezeigt. Die Eingaben werden durch Kreise symbolisiert. In manchen Darstellungen
wird auch die Bias-Einheit durch einen Kreis symbolisiert, manchmal wird auf die
Darstellung der Bias-Einheit verzichtet. Daher ist in dieser Grafik die
Bias-Einheit nicht in Reihe mit den Merkmalen, sondern etwas nach rechts
eingerückt. Die Multiplikation der Inputs $x_i$ mit den Gewichten $w_i$ wird
durch Kanten dargestellt. Die einzelnen Summanden $x_i w_i$ treffen sich
sozusagen im mittleren Kreis, wo auf die gewichtete Summe dann eine
Aktivierungsfunktion angewendet wird. Das Ergebnis, der Output $\hat{y}$ wird
