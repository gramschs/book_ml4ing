...
## Viele Perzeptronen = neuronales Netz
...
ML-Verfahren wird dann logistische Regression genannt.

Bei neuronalen Netzen werden vor allem die sogenannte
...
haben (keine Knicke wie die Heaviside-Funktion), können die Gewichte $w_1, w_2,
\ldots, w_n$ mit mathematischen Optimierungsverfahren besser bestimmt werden. Im
nächsten Kapitel werden wir sehen, wie das funktioniert.
